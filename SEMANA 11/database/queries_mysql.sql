...
CREATE DATABASE IF NOT EXISTS perno_todo_db;
USE perno_todo_db;
...
INSERT IGNORE INTO proveedores (nombre, contacto, telefono, email, direccion, ruc) VALUES
...
INSERT IGNORE INTO productos (codigo, nombre, descripcion, categoria, precio_compra, precio_venta, stock, stock_minimo, unidad_medida, proveedor_id) VALUES
